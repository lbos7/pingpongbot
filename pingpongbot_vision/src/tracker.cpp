...
public:
    Tracker() : Node("tracker") {
        ...
        // Declare the parameter for the ONNX model path
        this->declare_parameter<std::string>("onnx_model_path", "ppball_detection.onnx");

        // Retrieve the model path parameter
