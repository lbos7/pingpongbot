...
namespace pingpongbotlib {
    ...
    tf2::Transform odomUpdate(pingpongbot_msgs::msg::WheelAngles newWheelPositions) {
        double dtheta1 = newWheelPositions.theta1 - this->wheelPositons.theta1;
        double dtheta2 = newWheelPositions.theta2 - this->wheelPositons.theta2;
        double dtheta3 = newWheelPositions.theta3 - this->wheelPositons.theta3;
